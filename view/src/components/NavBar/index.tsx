    ...
    <nav className="bg-white fixed w-full h-[100px] z-20 top-0 start-0 border-b border-gray-200">
      <div className="max-w-screen relative flex flex-wrap items-center justify-center mx-auto p-4">
        ...
        <div className="text-center" id="navbar-sticky">
          <ul className="flex justify-center font-medium text-2xl  p-2">
            <li>
              <Link to='/'>
                <label className="block py-2 px-3 text-custom-dark-blue bg-transparent hover:cursor-pointer hover:text-3xl ">Home</label>
              </Link>
            </li>
            <li>
              <Link to='/add'>
                <label className="block py-2 px-3 text-custom-dark-blue bg-transparent hover:cursor-pointer hover:text-3xl ">New event</label>
              </Link>
            </li>
          </ul>
        </div>
